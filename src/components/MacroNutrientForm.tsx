...
const MacroNutrientForm: React.FC<MacroNutrientFormProps> = ({ onSubmit }) => {
  ...
  return (
    <div className="bg-cookify-darkgray rounded-xl overflow-hidden mb-6 animate-fade-in">
      ...
      {isExpanded && (
        <form onSubmit={handleSubmit} className="p-4 pt-0 grid grid-cols-2 gap-4">
          <div>
          ...
          <button 
            type="submit" 
            className="col-span-2 mt-2 py-3 px-6 rounded-lg bg-cookify-blue text-white font-medium hover:bg-blue-600 transition-colors"
          >
            Apply Macros
          </button>
        </form>
